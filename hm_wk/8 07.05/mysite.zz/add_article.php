          ...
          <div class="col-lg-auto col-md-auto mx-auto">
            <div class="page-heading">
              ...
              <table border="" align="">
                ...
                <tr>
                  <td valign="top"><textarea name="my_title" cols="25" rows="10" type="text" /></textarea></td>
                  <td valign="top"><textarea name="my_text" cols="65"
                      rows="20" type="text" /></textarea></td>
                  <td valign="top"><textarea name="my_subtitle" cols="25" rows="10" type="text" /></textarea></td>
                </tr>
              </table>
              <div align="center">
